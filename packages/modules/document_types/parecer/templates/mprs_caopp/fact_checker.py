"""Lexio — Parecer MPRS/CAOPP: FACT-CHECKER (AG-FACT-CHECKER)
Sonnet, temperature=0.1, max_tokens=3000

OpenClaw n8n v25.4: classificação VERIFICADO/NAO_VERIFICAVEL/ALUCINACAO,
verificação de tema, versão limpa sem alucinações.
"""
...
def system_prompt(context: dict) -> str:
    ...
    return (
        f'Você é VERIFICADOR DE FATOS do CAOPP/MPRS.\n'
        '<classificacao>\n'
