"""Lexio Module — Mandado de Segurança document type implementation."""
...
class MandadoSegurancaDocumentType(BaseDocumentType):
    """Mandado de Segurança — Pipeline for mandado de segurança generation."""

    TEMPLATES = {
        "generic": "packages.modules.document_types.mandado_seguranca.templates.generic",
    }
    ...
    def get_description(self) -> str:
        return "Geração de mandados de segurança com pipeline multi-agente. Direito líquido e certo — art. 5º LXIX CF, Lei 12.016/09."
    ...
    def get_pipeline_config(self, template_variant: str | None = None) -> PipelineConfig:
        ...
        return PipelineConfig(
            document_type_id="mandado_seguranca",
            name="Pipeline Mandado de Segurança",
            description=f"Pipeline completo para mandado de segurança (variante: {variant})",
            ...
            agents=[
                ...
                AgentConfig(
                    ...
                    temperature=0.3,
                    max_tokens=10000,
                    output_key="mandado_seguranca_bruta",
                ),
                AgentConfig(
                    name="revisor",
                    phase="revisor",
            ...
            quality_module="packages.modules.document_types.mandado_seguranca.quality_rules",
            integrator_module="packages.modules.document_types.mandado_seguranca.integrator_rules",
            search_datajud=True,
            search_web=True,
            min_score=60,
        )
