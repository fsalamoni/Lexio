"""Lexio Module — Contestacao document type implementation."""
...
class ContestacaoDocumentType(BaseDocumentType):
    """Contestacao (Defense/Answer) — Full multi-agent pipeline."""

    TEMPLATES = {
        "generic": "packages.modules.document_types.contestacao.templates.generic",
    }
    ...
    def get_description(self) -> str:
        return "Peça de defesa em processo judicial"
    ...
    def get_pipeline_config(self, template_variant: str | None = None) -> PipelineConfig:
        ...
        return PipelineConfig(
            ...
            name="Pipeline Contestação",
            description=f"Pipeline completo para contestação (variante: {variant})",
