...
2. Move one of the 4 remaining bounded repository slices out of `firestore-service.ts`: Settings/Migration, Admin Taxonomy, Dashboard Stats/Cost, or Chat, preserving public imports until callers migrate.
