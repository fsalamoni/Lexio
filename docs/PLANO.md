...
- 🔄 Próximo checkpoint: Problems, commit/push incremental e nova verificação remota do PR #143. Restam exatamente **3 fatias** planejadas em `firestore-service.ts`: Admin Taxonomy, Dashboard Stats/Cost e Chat.
