...
- 🔄 Próximo checkpoint: commit/push incremental e nova verificação remota do PR #143. Restam exatamente **4 fatias** planejadas em `firestore-service.ts`: Settings/Migration, Admin Taxonomy, Dashboard Stats/Cost e Chat.
