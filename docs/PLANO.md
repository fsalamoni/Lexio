...
- 🔄 Próximo bloco: fechar trilha one-shot de release da Wave 35 (run IDs reais) e consolidar governança/cache/handoff de continuidade cross-platform.
