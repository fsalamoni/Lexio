...
- 🔄 Próximo checkpoint: manifest/diff final, commit/push incremental e nova verificação remota do PR #143 antes de extrair Acervo ou Research Notebook de `firestore-service.ts`.
