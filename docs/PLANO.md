...
- 🔄 Próximo checkpoint: manifest JSON, `git diff --check`, Problems, commit/push incremental e nova verificação remota do PR #143. Restam exatamente **2 fatias** planejadas em `firestore-service.ts`: Dashboard Stats/Cost e Chat.
