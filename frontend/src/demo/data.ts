...
export const DEMO_THESES = [
  {
    ...
    document_type_id: 'parecer',
    content: 'A contratação direta por dispensa de licitação em razão de emergência...',
    quality_score: 94,
    usage_count: 12,
    status: 'active',
  ...
  },
  {
    ...
    legal_area_id: 'civil',
    document_type_id: 'peticao_inicial',
    content: 'A responsabilidade civil objetiva do Estado por erro médico...',
    quality_score: 89,
    usage_count: 7,
    status: 'active',
  ...
  },
  {
    ...
    legal_area_id: 'labor',
    document_type_id: 'contestacao',
    content: 'Cabe ao empregador o ônus de provar a ocorrência da falta grave...',
    quality_score: 96,
    usage_count: 15,
    status: 'active',
