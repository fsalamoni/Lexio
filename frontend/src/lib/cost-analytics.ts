...
const PHASE_LABELS: Record<string, string> = {
  ...
  inventario: 'Teses: Inventário Local',
  thesis_catalogador: 'Teses: Inventário Local (legado Catalogador)',
  thesis_analista: 'Analista de Redundâncias',
  thesis_analista_repair: 'Analista de Redundâncias (reparo JSON)',
