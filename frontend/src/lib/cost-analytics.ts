...
const PHASE_LABELS: Record<string, string> = {
  ...
  // Video Pipeline — per-part phases (generated by executeVideoFromScript)
  video_roteirista_part1: 'Vídeo: Roteirista (Parte 1)',
  video_roteirista_part2: 'Vídeo: Roteirista (Parte 2)',
  video_roteirista_part3: 'Vídeo: Roteirista (Parte 3)',
  video_detalhista_part1: 'Vídeo: Detalhista (Parte 1)',
  video_detalhista_part2: 'Vídeo: Detalhista (Parte 2)',
  video_detalhista_part3: 'Vídeo: Detalhista (Parte 3)',
  video_gerador_part1: 'Vídeo: Gerador (Parte 1)',
  video_gerador_part2: 'Vídeo: Gerador (Parte 2)',
  video_gerador_part3: 'Vídeo: Gerador (Parte 3)',
  // Audio Pipeline
