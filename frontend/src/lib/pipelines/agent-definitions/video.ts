...
export const VIDEO_PIPELINE_AGENT_DEFS: AgentModelDef[] = [
  ...
  },
  {
    ...
    bestModelNote: 'Gera imagens reais. Gemini Flash Image e Gemini 3.1 Flash Image Preview sao as rotas OpenRouter recomendadas; modelos premium podem ser usados quando qualidade visual for prioridade.',
  },
  {
    key: 'video_tts',
    label: 'Narrador TTS',
