...
export const VIDEO_PIPELINE_AGENT_DEFS: AgentModelDef[] = [
  ...
  },
  {
    ...
    bestModelNote: '⚠️ REQUER modelo de geração de IMAGEM (ex: DALL-E, Midjourney, Stable Diffusion via OpenRouter). Modelos somente de texto NÃO servem — geram apenas descrições, sem imagens reais.',
  },
  {
    ...
    bestModelNote: '⚠️ REQUER modelo de geração de VÍDEO (ex: Sora, Runway, Pika, Kling via OpenRouter). Modelos somente de texto NÃO servem para esta etapa.',
  },
  {
    key: 'video_narrador',
    label: 'Narrador',
    ...
    bestModelNote: '⚠️ REQUER modelo de geração de ÁUDIO/TTS (ex: ElevenLabs, OpenAI TTS via OpenRouter). Modelos somente de texto NÃO servem — geram apenas roteiros escritos, não áudio real.',
  },
  {
    key: 'video_revisor',
...
export const PRESENTATION_PIPELINE_AGENT_DEFS: AgentModelDef[] = [
  ...
  },
  {
    ...
    agentCategory: 'synthesis',
    requiredCapability: 'image',
    bestModelNote: '⚠️ REQUER modelo de geração de IMAGEM para assets visuais dos slides. Modelos somente de texto geram apenas descrições de layout, sem imagens ou gráficos reais.',
  },
  {
    key: 'pres_revisor',
