...
export const VIDEO_PIPELINE_AGENT_DEFS: AgentModelDef[] = [
  ...
  },
  {
    key: 'video_designer',
    label: 'Designer Visual',
    description: 'Gera prompts de imagem detalhados e descrições de assets visuais para cada cena (produz texto JSON, não imagens)',
    defaultModel: 'anthropic/claude-sonnet-4',
    recommendedTier: 'premium',
    icon: 'image',
    agentCategory: 'synthesis',
  ...
  },
  {
    ...
    description: 'Monta a timeline final do vídeo com transições, efeitos e sincronização de cenas (produz texto JSON)',
    defaultModel: 'anthropic/claude-sonnet-4',
    recommendedTier: 'premium',
    icon: 'video',
    agentCategory: 'synthesis',
  ...
  },
  {
    key: 'video_narrador',
    label: 'Narrador',
    description: 'Gera o script de narração/voice-over com marcações de timing e entonação (produz texto JSON)',
    defaultModel: 'anthropic/claude-sonnet-4',
    recommendedTier: 'balanced',
    icon: 'mic',
    agentCategory: 'writing',
...
export const AUDIO_PIPELINE_AGENT_DEFS: AgentModelDef[] = [
  ...
  },
  {
    key: 'audio_narrador',
    label: 'Narrador / TTS',
    description: 'Gera o roteiro detalhado de narração com entonações, pausas e marcações técnicas (produz texto JSON)',
    defaultModel: 'anthropic/claude-sonnet-4',
    recommendedTier: 'premium',
    icon: 'mic',
    agentCategory: 'synthesis',
...
export const PRESENTATION_PIPELINE_AGENT_DEFS: AgentModelDef[] = [
  ...
  },
  {
    ...
    description: 'Cria layout visual, esquemas de cores, especificações de gráficos e descrições de assets visuais (produz texto JSON)',
    defaultModel: 'anthropic/claude-sonnet-4',
    recommendedTier: 'premium',
    icon: 'pen-tool',
    agentCategory: 'synthesis',
