...
export const PROVIDERS: Record<ProviderId, ProviderDefinition> = {
  ...
  openai: {
    ...
    staticModels: [
      ...
      { id: 'gpt-4o-transcribe', label: 'GPT-4o Transcribe', tier: 'balanced', capabilities: ['audio'] },
      { id: 'gpt-4o-mini-transcribe', label: 'GPT-4o Mini Transcribe', tier: 'fast', capabilities: ['audio'] },
      { id: 'whisper-1', label: 'Whisper 1', tier: 'fast', capabilities: ['audio'] },
  ...
  fal: {
    ...
    description: 'Geração de vídeo real por IA — Veo, Kling, Wan, Hailuo e LTX. Basta colar sua chave fal.ai aqui: o chat passa a gerar vídeos literais, sem nenhuma configuração de servidor.',
    consoleUrl: 'https://fal.ai/dashboard/keys',
    keyPrefix: '',
    guide: [
      'Crie uma conta em fal.ai e adicione créditos — a geração de vídeo é cobrada por clipe pelo provedor.',
      'Acesse fal.ai/dashboard/keys e clique em "Add key".',
      'Copie a chave gerada e cole no campo acima; salve.',
      'Em Configurações → Orquestrador (Chat) → Agentes Geradores de Artefatos, escolha um modelo de vídeo (Veo 3, Kling, Wan, Hailuo ou LTX) no agente "Gerador de Vídeo Literal".',
      'Pronto: peça um vídeo no chat (ex.: "gere um vídeo de 8s de..."), aprove a geração e o MP4 aparece com player e download.',
    ],
    dialect: 'video-only',
