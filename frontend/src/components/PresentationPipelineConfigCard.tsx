      ...
      <div className="bg-white rounded-xl border mb-6 overflow-hidden">
        ...
        >
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className="text-lg font-semibold text-gray-900">Configurações do Pipeline de Apresentação</h2>
              <p className="text-sm text-gray-500">Configure o modelo LLM de cada agente da trilha multiagente de geração de apresentação</p>
            </div>
          </div>
          <div className="flex items-center gap-3">
            {hasNonDefaults && (
