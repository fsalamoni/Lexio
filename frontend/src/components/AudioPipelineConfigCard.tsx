 ...
 * which LLM models the multi-agent audio production pipeline uses.
 *
 * Follows the same design pattern as AcervoEmentaConfigCard
 * but targets the AUDIO_PIPELINE_AGENT_DEFS and audio_pipeline_models Firestore key.
 */
      ...
      <div className="bg-white rounded-xl border mb-6 overflow-hidden">
        ...
        >
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className="text-lg font-semibold text-gray-900">Pipeline de Áudio</h2>
              <p className="text-sm text-gray-500">Configure os modelos LLM para a produção multi-agente de áudios profissionais</p>
            </div>
          </div>
          <div className="flex items-center gap-3">
            {hasNonDefaults && (
        ...
        {expanded && (
          <div className="px-6 pb-6">
            ...
            <div className="flex items-center gap-2 mb-4 pb-3 border-b">
              ...
              <span className="text-sm font-semibold text-gray-700">Pipeline de Produção de Áudio</span>
              <span className="text-xs text-gray-400 ml-auto">6 agentes · pipeline de produção de áudio</span>
            </div>

            {/* Agent cards */}
            <div className="space-y-0">
              {AUDIO_PIPELINE_AGENT_DEFS.map((agent) => {
                    ...
                    <div className={`relative rounded-lg border p-4 transition-colors ${
                      ...
                      <div className="flex items-start gap-3">
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          {agent.bestModelNote && (
                            <p className="text-[10px] mt-1 px-2 py-0.5 rounded bg-violet-50 text-violet-600 inline-block font-medium">
                              💡 {agent.bestModelNote}
                            </p>
                          )}
            ...
            <div className="mt-4 p-3 bg-violet-50 border border-violet-200 rounded-lg">
              <p className="text-xs text-violet-800">
                🎙️ <strong>Pipeline de Áudio:</strong> A produção de áudio usa 6 agentes especializados — do planejamento e roteiro até narração e mixagem final. O Narrador/Locutor requer um modelo de TTS/áudio (como openai/tts-1-hd) — modelos somente-texto <strong>NÃO</strong> funcionam para esta etapa.
              </p>
            </div>
