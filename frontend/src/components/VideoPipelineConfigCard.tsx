 ...
 * which LLM models the multi-agent video production pipeline uses.
 *
 * Follows the same design pattern as AcervoEmentaConfigCard
 * but targets the VIDEO_PIPELINE_AGENT_DEFS and video_pipeline_models Firestore key.
 */
      ...
      <div className="bg-white rounded-xl border mb-6 overflow-hidden">
        ...
        >
          <div className="flex items-center gap-3">
            ...
            <div>
              <h2 className="text-lg font-semibold text-gray-900">Pipeline de Vídeo</h2>
              <p className="text-sm text-gray-500">Configure os modelos LLM para a produção multi-agente de vídeos profissionais</p>
            </div>
          </div>
          <div className="flex items-center gap-3">
            {hasNonDefaults && (
        ...
        {expanded && (
          <div className="px-6 pb-6">
            ...
            <div className="flex items-center gap-2 mb-4 pb-3 border-b">
              ...
              <span className="text-sm font-semibold text-gray-700">Pipeline de Produção de Vídeo</span>
              <span className="text-xs text-gray-400 ml-auto">8 agentes · pipeline de produção de vídeo</span>
            </div>

            {/* Agent cards */}
            <div className="space-y-0">
              {VIDEO_PIPELINE_AGENT_DEFS.map((agent) => {
                    ...
                    <div className={`relative rounded-lg border p-4 transition-colors ${
                      ...
                      <div className="flex items-start gap-3">
                        ...
                        <div className="flex-1 min-w-0">
                          ...
                          {agent.bestModelNote && (
                            <p className="text-[10px] mt-1 px-2 py-0.5 rounded bg-rose-50 text-rose-600 inline-block font-medium">
                              💡 {agent.bestModelNote}
                            </p>
                          )}
            ...
            <div className="mt-4 p-3 bg-rose-50 border border-rose-200 rounded-lg">
              <p className="text-xs text-rose-800">
                🎬 <strong>Pipeline de Vídeo:</strong> A produção de vídeo usa 8 agentes especializados que trabalham em sequência — do planejamento e roteiro até a geração visual e edição final. O Planejador cria uma proposta com custos estimados antes de iniciar. Para o Gerador de Cenas, apenas modelos com capacidade de geração de vídeo funcionam — modelos somente-texto <strong>NÃO</strong> são adequados para esta etapa.
              </p>
            </div>
