 ...
 *
 * Features:
 * - Visual pipeline flow showing all agents in execution order
 * - Rich model selector modal with 45+ models, filters, fit scores, costs
          ...
          <div className="px-6 pb-6">
            ...
            <div className="flex items-center gap-2 mb-4 pb-3 border-b">
              ...
              <span className="text-xs text-gray-400 ml-auto">
                {PIPELINE_AGENT_DEFS.length} agentes · execução sequencial
              </span>
            </div>
