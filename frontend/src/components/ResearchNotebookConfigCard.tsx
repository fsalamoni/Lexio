        ...
        {expanded && (
          <div className="px-6 pb-6">
            ...
            <div className="flex items-center gap-2 mb-4 pb-3 border-b">
              ...
              <span className="text-sm font-semibold text-gray-700">Pipeline do Caderno de Pesquisa</span>
              <span className="text-xs text-gray-400 ml-auto">{RESEARCH_NOTEBOOK_AGENT_DEFS.length} agentes · pesquisa, análise, chat e criação</span>
            </div>

            {/* Agent cards */}
            <div className="space-y-0">
              {RESEARCH_NOTEBOOK_AGENT_DEFS.map((agent, idx) => {
                ...
                const isLast = idx === RESEARCH_NOTEBOOK_AGENT_DEFS.length - 1
            ...
            <div className="mt-4 p-3 bg-indigo-50 border border-indigo-200 rounded-lg">
              <p className="text-xs text-indigo-800">
                <strong>📖 Sobre estes agentes:</strong> O Caderno de Pesquisa utiliza 4 agentes especializados —
                o <strong>Pesquisador de Fontes</strong> indexa conteúdo das fontes,
                o <strong>Analista de Conhecimento</strong> sintetiza e cruza referências,
                o <strong>Assistente Conversacional</strong> responde perguntas interativamente,
                e o <strong>Criador de Conteúdo</strong> gera artefatos no Estúdio (resumos, mapas mentais, cartões, etc.).
