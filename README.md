...
4. Para release sincronizado (recomendado), dispare `.github/workflows/release-web.yml` com `deploy_firebase=true` e `deploy_github_pages=true`; ajuste `deploy_redesign_v2` conforme a janela. Essa trilha foi validada end-to-end nos runs `24849029535`, `24849789759` e `24853129457` (quality gates + Firebase + Pages + release summary em sucesso, com redesign V2 opcional desativado).
