"""Lexio — Parecer genérico: REDATOR (Sonnet, temperature=0.3, max_tokens=8000)."""
...
def system_prompt(context: dict) -> str:
    ...
    return (
        ...
        f'<estrutura>\n'
        f'RELATÓRIO\n'
        f'- Descreva "{tema}" com contexto fático (2-3 parágrafos)\n'
        f'- Delimite o escopo da análise\n'
        f'\n'
        ...
        f'\n'
        f'CONCLUSÃO\n'
        f'- Síntese + recomendação CONCRETA\n'
